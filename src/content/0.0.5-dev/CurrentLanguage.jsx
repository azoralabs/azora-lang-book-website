...
export function CurrentLanguage() {
  return (
    <Section id="v005dev-language" title="1. Current Language">
      <Lead>
        This development edition starts from the Azora 0.0.4 book and tracks work toward 0.0.5. It is organised
        as a single story - read from the top, or jump to any chapter. Syntax may change as 0.0.5 evolves.
      </Lead>
      <p>
...
export function ModulesAndZones() {
  return (
    <Section id="v005dev-modules" title="1.1 Modules, imports, and zones">
      <Lead>
...
export function VariablesAndBindings() {
  return (
    <Section id="v005dev-variables" title="1.2 Variables & bindings">
      <Lead>
...
export function PrimitiveTypes() {
  return (
    <Section id="v005dev-primitive-types" title="1.3 Primitive types">
      <Lead>
...
export function OperatorsAndCasts() {
  return (
    <Section id="v005dev-operators" title="1.4 Operators & casts">
      <Lead>
...
export function Strings() {
  return (
    <Section id="v005dev-strings" title="1.5 Strings">
      <Lead>
...
export function ArraysAndCollections() {
  return (
    <Section id="v005dev-arrays" title="1.6 Arrays & collection literals">
      <Lead>
...
export function ControlFlow() {
  return (
    <Section id="v005dev-control-flow" title="1.7 Control flow">
      <Lead>
...
export function FunctionsAndLambdas() {
  return (
    <Section id="v005dev-functions" title="1.8 Functions & lambdas">
      <Lead>
...
export function PacksAndImpls() {
  return (
    <Section id="v005dev-packs" title="1.9 Packs, impls & properties">
      <Lead>
...
export function GenericsAndVariadics() {
  return (
    <Section id="v005dev-generics" title="1.10 Generics & variadics">
      <Lead>
...
export function SpecsAndTraits() {
  return (
    <Section id="v005dev-specs" title="1.11 Specs & traits">
      <Lead>
...
export function EnumsTuplesSlots() {
  return (
    <Section id="v005dev-enums" title="1.12 Enums, tuples & slots">
      <Lead>
...
export function ErrorsAndFailables() {
  return (
    <Section id="v005dev-errors" title="1.13 Errors & failable types">
      <Lead>
...
export function NullableTypes() {
  return (
    <Section id="v005dev-nullable" title="1.14 Nullable types">
      <Lead>
...
export function OwnershipAndReferences() {
  return (
    <Section id="v005dev-ownership" title="1.15 Ownership & references">
      <Lead>
...
export function MemoryModel() {
  return (
    <Section id="v005dev-memory" title="1.16 The memory model">
      <Lead>
...
export function CompileTimeExecution() {
  return (
    <Section id="v005dev-ctce" title="1.17 Compile-time execution">
      <Lead>
...
export function Contracts() {
  return (
    <Section id="v005dev-contracts" title="1.18 Contracts">
      <Lead>
...
export function ConcurrencyAndTasks() {
  return (
    <Section id="v005dev-concurrency" title="1.19 Concurrency & tasks">
      <Lead>
...
export function ReactivityAndComponents() {
  return (
    <Section id="v005dev-reactivity" title="1.20 Reactivity & components">
      <Lead>
...
export function Inheritance() {
  return (
    <Section id="v005dev-inheritance" title="1.21 Inheritance (node / leaf)">
      <Lead>
...
export function DiAndFfi() {
  return (
    <Section id="v005dev-di-ffi" title="1.22 Dependency injection & FFI">
      <Lead>
...
export function TestingAndTracing() {
  return (
    <Section id="v005dev-testing" title="1.23 Testing & tracing">
      <Lead>
