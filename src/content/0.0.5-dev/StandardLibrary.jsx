...
export function StandardLibrary() {
  return (
    <Section id="v005dev-stdlib" title="2. Standard Library">
      <Lead>
...
func main() {
    ...
    fin tags = std::listOf("azora", "0.0.5-dev")
...
export function ImportsAndConventions() {
  return (
    <Section id="v005dev-stdlib-conventions" title="2.1 Imports and conventions">
      <Lead>
...
export function IoChapter() {
  return (
    <Section id="v005dev-stdlib-io" title="2.2 IO">
      <Lead>
...
export function ConvertChapter() {
  return (
    <Section id="v005dev-stdlib-convert" title="2.3 Convert">
      <Lead>
...
export function MathChapter() {
  return (
    <Section id="v005dev-stdlib-math" title="2.4 Math">
      <Lead>
...
export function StringsAndCharsChapter() {
  return (
    <Section id="v005dev-stdlib-strings" title="2.5 Strings & chars">
      <Lead>
...
export function RandomChapter() {
  return (
    <Section id="v005dev-stdlib-random" title="2.6 Random">
      <Lead>
...
export function ResultChapter() {
  return (
    <Section id="v005dev-stdlib-result" title="2.7 Result">
      <Lead>
...
export function FunctionalChapter() {
  return (
    <Section id="v005dev-stdlib-functional" title="2.8 Functional">
      <Lead>
...
export function TraitsChapter() {
  return (
    <Section id="v005dev-stdlib-traits" title="2.9 Traits">
      <Lead>
...
export function AlgorithmChapter() {
  return (
    <Section id="v005dev-stdlib-algorithm" title="2.10 Algorithm">
      <Lead>
...
export function MemoryChapter() {
  return (
    <Section id="v005dev-stdlib-memory" title="2.11 Memory">
      <Lead>
...
export function ConcurrencyStdlibChapter() {
  return (
    <Section id="v005dev-stdlib-concurrency" title="2.12 Concurrency">
      <Lead>
...
export function ParallelismChapter() {
  return (
    <Section id="v005dev-stdlib-parallelism" title="2.13 Parallelism">
      <Lead>
...
export function MacroChapter() {
  return (
    <Section id="v005dev-stdlib-macro" title="2.17 Macro">
      <Lead>
...
export function ReflectionChapter() {
  return (
    <Section id="v005dev-stdlib-reflection" title="2.18 Reflection">
      <Lead>
...
export function ReactiveChapter() {
  return (
    <Section id="v005dev-stdlib-reactive" title="2.19 Reactive">
      <Lead>
