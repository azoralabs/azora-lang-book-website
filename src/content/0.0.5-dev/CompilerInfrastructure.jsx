...
export function CompilerInfrastructure() {
  return (
    <Section id="v005dev-compiler" title="3. Compiler infrastructure">
      <Lead>
...
export function CompilerOverviewChapter() {
  return (
    <Section id="v005dev-compiler-overview" title="3.1 Overview & orchestration">
      <Lead>
...
export function FrontendChapter() {
  return (
    <Section id="v005dev-compiler-frontend" title="3.2 Frontend">
      <Lead>
...
export function PreSemanticChapter() {
  return (
    <Section id="v005dev-compiler-presemantic" title="3.3 Pre-semantic rewrites">
      <Lead>
...
export function SemanticPipelineChapter() {
  return (
    <Section id="v005dev-compiler-semantic" title="3.4 Semantic pipeline">
      <Lead>
...
export function StdlibInjectionChapter() {
  return (
    <Section id="v005dev-compiler-stdlib" title="3.5 Standard-library injection">
      <Lead>
...
export function IrGenerationChapter() {
  return (
    <Section id="v005dev-compiler-ir" title="3.6 IR generation">
      <Lead>
...
export function JavaScriptBackendChapter() {
  return (
    <Section id="v005dev-compiler-js" title="3.7 JavaScript backend">
      <Lead>
...
export function WasmBackendChapter() {
  return (
    <Section id="v005dev-compiler-wasm" title="3.8 WebAssembly backend">
      <Lead>
...
export function LlvmBackendChapter() {
  return (
    <Section id="v005dev-compiler-llvm" title="3.9 LLVM backend">
      <Lead>
...
export function InterpreterChapter() {
  return (
    <Section id="v005dev-compiler-interp" title="3.10 Interpreter">
      <Lead>
...
export function BridgesFfiChapter() {
  return (
    <Section id="v005dev-compiler-bridges" title="3.11 Bridges & FFI">
      <Lead>
